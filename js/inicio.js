config = {
	type: Phaser.AUTO,
	width:  1500,//window.screen.width,
	height: 676,// window.screen.height,//innerHeight,
	parent: 'parentela',
	dom: {
	...
	scale:{
		...
		autoCenter: true,
		orientation: 'landscape-primary' //'portrait-primary'//'landscape'
	},
	physics: {
		default: 'arcade',
		arcade: {
	...
	scene:[Entrada,SceneCarga,Intro,main] 
};
