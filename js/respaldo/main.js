...
//		StatusBar.hide();
	...
	cam.setBackgroundColor('rgb(133,160,190)')
	...
	this.add.image(0, 0, 'arcos').setOrigin(0)
		.setDisplaySize(cam.width, cam.height)
		.setDepth(2)
		...
		onComplete: () => {
			...
			onComplete: () => {
				let partFin = estaEscena.add.particles(0,0,'estrella',{
					...
					tint: {random: [0xf3230e,0x15e20f,0x0f35e2,0xf8f81c,0x16f7f3,0xa816f7,0xfdb12b,0xd42bfd]},
					frequency: 80,
